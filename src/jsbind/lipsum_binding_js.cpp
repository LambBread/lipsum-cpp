...
EMSCRIPTEN_BINDINGS(lipsumcpp) {
    ...
    function("lpsm_GenerateDefaultLipsumSentence", &lpsm::GenerateDefaultLipsumSentence);
    ...
    function("lpsm_GenerateMarkdownParagraph", &lpsm::GenerateMarkdownParagraph);
    function("lpsm_GenerateMarkdownText", &lpsm::GenerateMarkdownText);
    function("lpsm_GenerateSentenceFragmentX", &lpsm::GenerateSentenceFragmentX);
    ...
    function("lpsm_GenerateMarkdownParagraphs", &lpsm::GenerateMarkdownParagraphs);
}
