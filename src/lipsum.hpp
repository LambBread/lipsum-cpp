 ...
 *
 * @return std::string Returns the random sentence fragment.
 */
 ...
 *
 */
std::string GenerateSentences(int sentCount = 6, const ArgVec2& word = ArgVec2(4, 9), const ArgVec2& frag = ArgVec2(1, 3), bool useLipsum = true);
/**
