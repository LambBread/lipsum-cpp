 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_COMMIT = "32da2db";
 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_DATE = "26062203";
#endif
