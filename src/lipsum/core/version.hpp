 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION = "0.4.3";
 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_COMMIT = "53dad05";
 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_FULL = "0.4.3-53dad05";
