 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_COMMIT = "f2f3f7b";
 ...
 */
inline constexpr const char* LIPSUM_CPP_VERSION_DATE = "26062502";
#endif
