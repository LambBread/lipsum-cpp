...
int main()
{
    ...
    //generate 100 paragraphs of 7-10 sentences and 8-20 words per sentence, not starting with "Lorem ipsum..."
    std::cout << lipsum::GenerateParagraphs(100, 7, 10, 8, 20, false);
    return 0;
}
